...
5. Copy over the changed files.
	* Version v1.01 to v1.07 files changed: **README.md, triviatime.css, about.html.php, plugin.py, config.py, __init__.py** (the changes to config only involded descriptions; no changes to database).
	* Version v1.03 to v1.07 files changed: **README.md, plugin.py, __init__.py, config.py** (the changes to config only involded descriptions; no changes to database).
