...
class ASCII(callbacks.Plugin):
    ...
    def __init__(self, irc):
        ...
        self.rgbColors = [
            ...
            (255,255,255)]
        self.ircColors= {
            (100.0, 0.0053, -0.0104):'00',
            (0.0, 0.0, 0.0):'01',
            (12.8119, 47.2407, -64.3396):'02',
            (52.8041, -57.1624, 55.1703):'03',
            (53.2329, 80.1093, 67.2201):'04',
            (25.2966, 47.7847, 37.7562):'05',
            (36.8705, 68.0659, -42.1489):'06',
            (66.4237, 42.1616, 73.4335):'07',
            (97.1382, -21.5559, 94.4825):'08',
            (86.8105, -85.4149, 82.4382):'09',
